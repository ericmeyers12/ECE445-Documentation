...
\begin{center}
	\large
	$ 5*10^{-3} * Tan^{-1}(\frac{.5}{300})* 1000 = 0.00833333 [\frac{J}/{m^2}]$
	$18 (.25)^{0.75} = $ \\
\end{center}
...
Where P is the power of the beam ($6.25*10^{-8} J$) and $w$ is the waist of the beam, $4mm$. This gives an NOHD of 
