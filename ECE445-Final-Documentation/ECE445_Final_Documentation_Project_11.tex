...
There are strict requirements on the power module to provide at least 8 hours of a steady 3.3V output. Originally, in the design review, a 3.3V boost-converter was going to be utilized along with a single AA battery (1.5V) to supply the entire interrogator unit. This proved to be a difficult implementation For this reason, 

\hspace{5mm}\textbf{Laser Transmitter} \label{section:laser-transmitter-design-procedure}
A 5 mW 650nm laser transmitter was used for the interrogator which was placed inside of casing made out of a hollow aluminum tube. This coupled with single convex and concave lens was used d
