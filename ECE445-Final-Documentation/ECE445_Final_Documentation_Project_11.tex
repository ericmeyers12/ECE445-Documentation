...
These functions and features are summarized in the system block diagram shown in \autoref{fig:system-block-diagram} Figure \ref{fig:system-block-diagram}. 
...
This gives us a system of equations with two unknowns: 
...
\hspace{5mm}\textbf{Laser Safety}
 ...
 These calculations show that the team was safe using a laser up to 1.25 meters.If absolutely necessary to work with the laser powered on and a person within $1.25m$ of the laser, the person was required to wear protective eye wear. 

 The team took precautions to avoid eye contact with the laser within $1.25m$ of the source. If it was absolutely necessary to work with the laser powered on and a person within $1.25m$ of the laser, the person wore protective eye weat

 
 The risk of eye damage was mitigated by the fact that the laser is both visible, and not always powered on. 
...
The requirement driving both the R.F. transmitter and receiver was the ability to broadcast and receive packets (as a pair) at the maximum distance of the project ($30m$). The theoretical maximum distance was explored in the design review and thus will not be discussed here. On both the friendly interrogator PCB and the target PCB, the 3.23mm (50 $\Omega$) microstrip line was fabricated, but not used in the final implementation.
...
\end{table}%
Assuming a standard alkaline battery has 1500mAh on a full charge, the total active time can be calculated as,
\begin{equation}  \large
